...
//	horizontalHeader << QStringLiteral("名称");
//	horizontalHeader << QStringLiteral("性别");
//	horizontalHeader << QStringLiteral("进度");
//	ui.widget_tableWidget->SetHorizontalHeaderList(horizontalHeader);
