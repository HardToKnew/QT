...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(305, 364);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QStringLiteral("centralwidget"));
        widget = new QWidget(centralwidget);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(20, 0, 261, 321));
        ...
        horizontalSpacer_4 = new QSpacerItem(32, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_4);

        splitter->addWidget(widget2);

        gridLayout->addWidget(splitter, 1, 1, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindow", "QTread", Q_NULLPTR));
    } // retranslateUi
